...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clonecount = 0
        self.startingx = self.start.x
        self.startingy = self.start.y
        self.endingx = self.end.x
        self.endingy = self.end.y
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        linenew = Line(Point(self.start.x+other_line.start.x, self.start.y+other_line.start.y),Point(self.end.x+other_line.end.x,self.end.y+other_line.end.y))
        return linenew
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        linenew = Line(Point(self.start.x - other_line.start.x, self.start.y - other_line.start.y),
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start.x = self.startingx
        self.start.y = self.startingy
        self.end.x = self.endingx
        self.end.y = self.endingy
